...
db = SQLDatabase.from_uri("sqlite:///task_list.db")
...
system_propmt = """
    ...
    3. If the user requests a list of tasks, present the output in a structured table format to ensure clean and organised display in the browser.
